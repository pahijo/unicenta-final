 ...
 * @author JG uniCenta
 */
public class JPaymentNequi extends javax.swing.JPanel implements JPaymentInterface {
     ...
     * @param notifier */
    public JPaymentNequi(JPaymentNotifier notifier) {
    ...
    public PaymentInfo executePayment() {
        return new PaymentInfoTicket(m_dPaid, "Nequi");      
    }
