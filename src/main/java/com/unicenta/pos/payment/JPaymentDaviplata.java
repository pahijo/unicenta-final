 ...
 * @author JG uniCenta
 */
public class JPaymentDaviplata extends javax.swing.JPanel implements JPaymentInterface {
     ...
     * @param notifier */
    public JPaymentDaviplata(JPaymentNotifier notifier) {
    ...
    public PaymentInfo executePayment() {
        return new PaymentInfoTicket(m_dPaid, "Daviplata");      
    }
